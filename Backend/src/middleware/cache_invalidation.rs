        ...
        let groups = vec![
            ...
            CacheGroup::new(
                ...
                vec![
                    ...
                    "PUT /api/wallet/bank-accounts/*/primary",
            ...
            CacheGroup::new(
                ...
                vec![
                    "GET /api/labour/worker/profile",
                    "GET /api/labour/worker/portfolio",
                    "GET /api/labour/jobs",
                    "GET /api/labour/jobs/*",
                    "GET /api/labour/workers/search",
                    "GET /api/labour/workers/*",
                    "GET /api/labour/worker/dashboard",
                    "GET /api/labour/employer/dashboard",
                    "GET /api/labour/contracts",
                    "GET /api/labour/contracts/*",
                    "GET /api/labour/applications/*",
                ],
                vec![
                    "POST /api/labour/worker/profile",
                    "PUT /api/labour/worker/profile/availability",
                    "POST /api/labour/worker/portfolio",
                    "DELETE /api/labour/worker/portfolio/*",
                    "POST /api/labour/jobs",
                    "POST /api/labour/jobs/*/applications",
                    "PUT /api/labour/jobs/*/assign",
                    "POST /api/labour/jobs/*/contract",
                    "PUT /api/labour/jobs/*/complete",
                    "POST /api/labour/jobs/*/review",
                    "POST /api/labour/jobs/*/dispute",
                    "PUT /api/labour/disputes/*/resolve",
                    "PUT /api/labour/contracts/*/sign",
                    "PUT /api/labour/applications/*/review",
                    "POST /api/labour/jobs/*/escrow/release",
                ]
            ),
            ...
            CacheGroup::new(
                ...
                vec![
                    "GET /api/chat/chats",
                    "GET /api/chat/chats/*",
                    "GET /api/chat/chats/*/messages",
                    "GET /api/chat/unread-count",
                ],
                vec![
                    "POST /api/chat/chats",
                    "POST /api/chat/chats/*/messages",
                    "PUT /api/chat/chats/*/read",
                    "POST /api/chat/chats/*/contract-proposal",
                    "PUT /api/chat/contract-proposals/*/respond",
                ]
            ),
